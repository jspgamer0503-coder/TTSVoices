...
# ── Theme definitions extracted to tts_voices/gui/themes.py ────────────────
try:
    from tts_voices.gui.themes import THEMES
except ImportError:
    THEMES = {"dark": {"label":"⬛ AMOLED", "bg":"#000000","surface":"#050508","surface2":"#0a0a10","border":"#1a1a2e","border2":"#22223a","accent":"#1a6cf5","accent2":"#00c8ff","accent_dim":"#0a2a6e","text":"#e2eaff","text2":"#7a98c8","muted":"#3a4a6a","success":"#00d97e","warning":"#f59e0b","error":"#ef4444","speak_bg":"#1553d0","speak_hover":"#1d6aff","stop_bg":"#6a1010","stop_hover":"#c0392b","header_bg":"#000000","nav_btn":"#0a0a10","nav_hover":"#14142a","hover":"#14142a","textarea_bg":"#000000","textarea_fg":"#e2eaff","scrollbar":"#0a0a10","cursor":"#00c8ff","sel_bg":"#0a2a6e","pill_bg":"#000000"}}
...
class TTSVoicesApp:
    ...
    def _preview_voice(self):
        ...
        (matters for quality — Kokoro > espeak > Edge TTS on most
        hardware, with Edge available as opt-in cloud).
        """
