...
> shipped with AI assistance. The current 2.5.1 release is a maintenance
> update that bumps the version to match the VERSION file and fixes version
> inconsistencies across the codebase and documentation.
>
